    ...
    <div className="run-detail-page">
      <div className="page-header">
        ...
        <p className="page-description">
          Public metrics, provenance, and source traces for a specific simulation <GlossaryTooltip termKey="run">run</GlossaryTooltip>. A <GlossaryTooltip termKey="day">day</GlossaryTooltip> here is a simulation cycle, not a 24-hour calendar day.
        </p>
      </div>
