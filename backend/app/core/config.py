...
class Settings(BaseSettings):
    ...
    SURVIVAL_RESERVE_ACTIVE_AID_TRIGGER_FOOD: float = 2.0
    SURVIVAL_RESERVE_ACTIVE_AID_TRIGGER_ENERGY: float = 2.0
    SURVIVAL_RESERVE_ACTIVE_AID_TARGET_FOOD: float = 3.0
    SURVIVAL_RESERVE_ACTIVE_AID_TARGET_ENERGY: float = 3.0
    SURVIVAL_RESERVE_ACTIVE_AID_MIN_POOL_REMAINING: float = 25.0
    SURVIVAL_RESERVE_DORMANT_MAINTENANCE_ENABLED: bool = True
