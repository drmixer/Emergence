...
SCARCITY_PRESETS: dict[str, ScarcityPreset] = {
    ...
    "internal_canary_k9_pool_floor_pressure_v1": ScarcityPreset(
        name="internal_canary_k9_pool_floor_pressure_v1",
        description=(
            "Canary K9 active-aid pressure diagnostic. Matches K7 exactly except for a stricter "
            "active reserve-aid pool floor, so executable aid can prevent immediate collapse "
            "without spending the finite reserve down to a near-coasting cushion."
        ),
        runtime_overrides={
            "AGENT_LOOP_DELAY_SECONDS": 180,
            **CANARY_TUNING_RUNTIME_OVERRIDES,
            ...
            "SURVIVAL_RESERVE_ACTIVE_AID_TARGET_FOOD": 3.0,
            "SURVIVAL_RESERVE_ACTIVE_AID_TARGET_ENERGY": 3.0,
            "SURVIVAL_RESERVE_ACTIVE_AID_MIN_POOL_REMAINING": 75.0,
            "SURVIVAL_RESERVE_DORMANT_MAINTENANCE_ENABLED": False,
            "SURVIVAL_RESERVE_AUTO_REVIVE_ENABLED": False,
            "SURVIVAL_RESERVE_AUTO_CONTRIBUTION_ENABLED": False,
            "WORK_YIELD_FARM_BASE": 1.4,
